...
export default function BlogHero() {
  return (
    <section className="relative w-full h-[600px] bg-black flex flex-col items-center justify-center overflow-hidden">
      {/* Gradient Background */}
      <div className="absolute inset-0 w-full h-full z-0 pointer-events-none bg-gradient-to-b from-[#3A29FF]/20 via-[#FF94B4]/20 to-[#FF3232]/20"></div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6 mt-20">
        ...
        <p className="text-2xl text-white/90 mb-8 leading-relaxed">
          Sharing insights on AI, cybersecurity, and full-stack development
        </p>
        <div className="flex flex-wrap justify-center gap-4 text-white/80">
          ...
          <span className="px-4 py-2 bg-white/10 rounded-full backdrop-blur-sm">Web Development</span>
          <span className="px-4 py-2 bg-white/10 rounded-full backdrop-blur-sm">Tutorials</span>
        </div>
      </div>
    </section>
  );
